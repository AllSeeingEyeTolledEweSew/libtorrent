...
def render_section(names: List[str], description: str, types: List[str]) -> None:
    ...
    print(
        "| %s | %s |"
        % (print_field("name", max_name_len), print_field("type", max_type_len)),
        file=out,
    )
    ...
    for i in range(len(names)):
        print(
            ...
            % (
                ...
                print_field(types[i], max_type_len),
            ),
            file=out,
        )
        print(separator, file=out)
